...
**peira code:** `NON-PERCEPTION` · **Buddhist — Madhyamaka and Dignāgan logic** · **Enforced** — owns a gate
...
**In the tradition:** Dharmakīrti (7th c.) admits non-perception (anupalabdhi) as a way to establish absence (abhāva) — but only under the perceivability condition (dṛśyānupalabdhi): the thing, were it present, would have been perceived; the apparatus works; the conditions suffice. Of the imperceptible (adṛśya) it proves nothing. The lens keeps the restriction: "none found" is evidence of absence only when the search could have found the thing.
