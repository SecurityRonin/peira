...
|---|---|---|---|
| 1 | **Direction** | Which way do I want this to come out, and which way hurts more if I'm wrong? | [`BLACKSTONE`]({{ '/lenses/blackstone/' | relative_url }}), [`IDOLA`]({{ '/lenses/idola/' | relative_url }}) (bias) |
| 2 | **Words** | What is the yardstick, and do the words hold still? | [`LIJI`]({{ '/lenses/liji/' | relative_url }}) 立極, [`ZHENGMING`]({{ '/lenses/zhengming/' | relative_url }}) 正名, [`TIYONG`]({{ '/lenses/tiyong/' | relative_url }}) 體用 |
| 3 | **Ground** | How does it know, and can that way of knowing reach this far? | [`TOULMIN`]({{ '/lenses/toulmin/' | relative_url }}), [`PRAMANA`]({{ '/lenses/pramana/' | relative_url }}), [`RUNG`]({{ '/lenses/rung/' | relative_url }}) (causal), [`ANUPALABDHI`]({{ '/lenses/anupalabdhi/' | relative_url }}) 不可得因, `PEIR-LINT-ORPHAN-CLAIM`/`-UNGROUNDED-CHAIN`, `PEIR-LINT-FALSE-INDEPENDENCE` |
| 4 | **Rivals** | What else would look exactly like this, and who got left out of the ring? | [`ACH`]({{ '/lenses/ach/' | relative_url }}), [`TRAIRUPYA`]({{ '/lenses/trairupya/' | relative_url }}) 因三相, [`CATUSKOTI`]({{ '/lenses/catuskoti/' | relative_url }}) 四句, [`STEELMAN`]({{ '/lenses/steelman/' | relative_url }}), [`MACHLOKET`]({{ '/lenses/machloket/' | relative_url }}) |
| 5 | **Breaks** | Where does it break — on its own pages, against the world, after a date, past a case? | [`DUNG`]({{ '/lenses/dung/' | relative_url }}), [`AUFHEBUNG`]({{ '/lenses/aufhebung/' | relative_url }}), `PEIR-BOUNDARIES-MISSING` (under [`RUNG`]({{ '/lenses/rung/' | relative_url }})), [`BAIMA`]({{ '/lenses/baima/' | relative_url }}) 白馬非馬, [`PREMORTEM`]({{ '/lenses/premortem/' | relative_url }}), [`THESEUS`]({{ '/lenses/theseus/' | relative_url }}) |
| 6 | **Silence** | What should be here and isn't, and what was cut without a reason on record? | [`LACUNA`]({{ '/lenses/lacuna/' | relative_url }}) 闕文, [`CHESTERTON`]({{ '/lenses/chesterton/' | relative_url }}) |
| 7 | **Transfer** | Can I run it on a case the source never mentions? | [`GEWU`]({{ '/lenses/gewu/' | relative_url }}) 格物致知·知行合一 |
...
**A "none found" is itself an absence claim** — the pass's own [`ANUPALABDHI`]({{ '/lenses/anupalabdhi/' | relative_url }}). Write it as *"searched
...
[`claim-grading.md`]({{ '/method/claim-grading/' | relative_url }})'s axis applied to distillation — `[QUOTED]` is a fact about a
...
[`README.md`]({{ '/method/' | relative_url }})'s controlling idea, made a rule of the pass:
...
The four lenses this pass adds — [`GEWU`]({{ '/lenses/gewu/' | relative_url }}), [`LACUNA`]({{ '/lenses/lacuna/' | relative_url }}), [`IDOLA`]({{ '/lenses/idola/' | relative_url }}), [`BLACKSTONE`]({{ '/lenses/blackstone/' | relative_url }}) — are **catalogued, not
